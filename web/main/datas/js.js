...
function uploadFile() {
    ...
    if(document.getElementById('fileName').innerHTML === 'Name: '|| document.getElementById('fileName').innerHTML === ''){
        noFile();
        return;
    }
    ...
    xhr.open("POST", "/Upload");//修改为自己服务器接口地址
...
function noFile() {
    document.getElementById("msg").innerHTML = "未选择文件";
}