<%@ page import="Server.CommonServer" %>
							...
							<li class="col-sm-12 col-md-4 col-xs-12">
								<a href="javascript:;" class="clearfix">
									...
									<div class="right-text-con">
										<p class="name">会员数</p>
										<p><span class="color-org"><%=fs.SumUsers()%></span></p>
									</div>
								</a>
							</li>
							<li class="col-sm-12 col-md-4 col-xs-12">
								<a href="javascript:;" class="clearfix">
									...
									<div class="right-text-con">
										<p class="name">文章数</p>
										<p><span class="color-blue"><%=fs.SumBlog()%></span></p>
									</div>
								</a>
							</li>
							<li class="col-sm-12 col-md-4 col-xs-12">
								<a href="javascript:;" class="clearfix">
									...
									<div class="right-text-con">
										<p class="name">文件数</p>
										<p><span class="color-green"><%=fs.SumFile()%></span></p>
									</div>
								</a>
							</li>
						</ul>
					...
					<div class="server-panel panel panel-default">
						...
						<div class="panel-body clearfix">
							...
							<div class="col-md-2">
								...
								<span class="info"><%=cs.GetTime()%></span>
							</div>
						</div>
					</div>
				</div>
