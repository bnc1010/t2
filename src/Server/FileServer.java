...
public class FileServer {
     ...
     * paras[2]每页文件数
     */
    public FileBean[] GetFiles(UserBean user, int index) throws Exception{
        FileBean [] ret = new FileBean[11];
        dbBean.openConnection();
        sql = "SELECT * from files where uid=? limit ?, ?";
     ...
     *保存文件
     */
    public boolean SaveFile(UserBean user, String file, String fid, String sz)throws Exception{
        dbBean.openConnection();
