...
public class UploadServlet extends HttpServlet {
    ...
    // 上传配置
    private static final int MEMORY_THRESHOLD   = 1024 * 1024 * 1024;  // 3MB
    private static final long MAX_FILE_SIZE     = 1024 * 1024 * 1024; // 40MB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                for (FileItem item : formItems) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        try {
                            fs.SaveFile(user, fileName, fid, sz);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
        ...
        // 跳转到 message.jsp
        //getServletContext().getRequestDispatcher("/main/datas/message.jsp").forward(request, response);
    }
}